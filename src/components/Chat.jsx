...
const Chat = () => {
  ...
  return (
    <div className="nav-item absolute right-5 md:right-52 top-16 bg-white dark:bg-gray-900 p-8 rounded-lg w-96 shadow-xl shadow-gray-300 dark:shadow-gray-700">
      <div className="flex justify-between items-center">
        ...
        <CloseButton handleClick={() => setIsClicked(isClicked.chat === "false")} />
      </div>
      <div className="mt-5 ">
