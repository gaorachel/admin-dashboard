...
const UserProfile = () => {
  ...
  return (
    <div className="nav-item absolute right-1 top-16 bg-white dark:bg-gray-900 p-8 rounded-lg w-96 shadow-xl shadow-gray-300 dark:shadow-gray-700">
      <div className="flex justify-between items-center">
        <p className="font-semibold text-lg dark:text-gray-200">User Profile</p>
        <CloseButton handleClick={() => setIsClicked(isClicked.userProfile === "false")} />
      </div>
